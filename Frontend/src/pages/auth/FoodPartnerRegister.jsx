        ...
        <form className="auth-form" onSubmit={handleSubmit} noValidate>
          ...
          <div className="two-col">
            <div className="field-group">
              ...
              <input id="contactName" name="contactName" placeholder="Name" autoComplete="name" />
            </div>
            <div className="field-group">
          ...
          <div className="field-group">
            ...
            <input name="fssai" placeholder="Not checked for now" />
          </div>

          <div className="field-group">
            <label>Upload FSSAI Certificate (Optional for now)</label>
